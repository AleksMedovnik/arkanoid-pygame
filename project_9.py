...
while True:
    ...
    # Задание №1.
    # Если шарик улетает за пределы карты, вывести в консоль "GAME OVER!" и закрыть окно с игрой
    if ball.bottom > HEIGHT:
        print('GAME OVER!')
        exit()
    # Задание №2.
    # Если все блоки уничтожены, вывести в консоль "WIN!!!" и закрыть окно с игрой
...
# ДЗ
# Настроить игру по сложности, цветовую гамму проекта и размеры объектов на свой вкус.
